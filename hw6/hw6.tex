...
\begin{enumerate}[label=(\arabic*)]
    ...
    计算状态间的转移关系，绘制状态转移图如下：
    
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[
            state/.style={rectangle, draw, align=left, minimum width=3.5cm, minimum height=1.8cm, rounded corners},
        ...
        \node[state] (I0) at (0,0) {
            $I_0$: \\ 
            $S' \rightarrow \cdot S$ \\
            $S \rightarrow \cdot x = E$ \\
            $S \rightarrow \cdot E$ \\
            $E \rightarrow \cdot E + x$ \\
            $E \rightarrow \cdot x$
        };
        ...
        \node[state] (I8) at (4,-9) {
            $I_8$: \\
            $E \rightarrow E + x \cdot$
        };
                
        % 状态转移箭头
        \draw[arrow] (I0) -- node[above] {$S$} (I1);
        \draw[arrow] (I0) -- node[left] {$x$} (I2);
        \draw[arrow] (I0) -- node[right] {$E$} (I3);
        
        \draw[arrow] (I2) -- node[left] {$=$} (I4);
        
        \draw[arrow] (I3) -- node[right] {$+$} (I5);
        
        \draw[arrow] (I4) -- node[left] {$E$} (I6);
        \draw[arrow] (I4) -- node[above right] {$x$} (I7);
        
        \draw[arrow] (I5) -- node[right] {$x$} (I8);
        
        \draw[arrow] (I6) -- node[above] {$+$} (I5);
                
        % Accept箭头
        \node[right=0.5cm of I1] (Accept) {Accept};
        \draw[arrow] (I1) -- node[above] {$\$$} (Accept);
        \end{tikzpicture}
    \end{figure}
...
\begin{enumerate}[label=(\arabic*)]
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[
            state/.style={rectangle, draw, align=left, minimum width=4.5cm, minimum height=2.2cm, rounded corners},
            arrow/.style={->, >=stealth, thick},
            node distance=4.5cm
        ]
        ...
        % 状态转移箭头
        \draw[arrow] (I0) -- node[above] {$S$} (I1);
        \draw[arrow] (I0) -- node[above, pos=0.4] {$x$} (I2);
        \draw[arrow] (I0) -- node[above, pos=0.4] {$E$} (I3);
        ...
        \draw[arrow] (I4) -- node[left] {$E$} (I6);
        \draw[arrow] (I4) -- node[right, pos=0.3] {$x$} (I7);
        
        \draw[arrow] (I5) -- node[right] {$x$} (I8);
        
        \draw[arrow] (I6) to node[above] {$+$} (I5);
